...
async function seed() {
  ...
  for (const admin of adminAccounts) {
    // Nullify doctorId on any kids owned by admin before deleting
    await db.update(kidsTable).set({ doctorId: null }).where(eq(kidsTable.doctorId, admin.id));
  ...
  // ── 3. Seed 60 keto-appropriate foods ─────────────────────────────────────
  ...
  if (existingFoodCount.length < 30) {
    const foods = [
      ...
      { name: "Bell Pepper (Green)", category: "Vegetables", carbs: 4.6, fat: 0.3, protein: 0.9, calories: 20, indicator: "vegi", description: "Green peppers lower in carbs than red" },
      ...
      { name: "Mushrooms (Button)", category: "Vegetables", carbs: 3.3, fat: 0.3, protein: 3.1, calories: 22, indicator: "vegi", description: "Savory and low carb" },
      { name: "Lettuce (Romaine)", category: "Vegetables", carbs: 2.4, fat: 0.3, protein: 1.2, calories: 17, indicator: "vegi", description: "Classic salad base for keto meals" },
      { name: "Green Beans", category: "Vegetables", carbs: 7, fat: 0.1, protein: 1.8, calories: 31, indicator: "vegi", description: "Moderate carb, kid-friendly vegetable" },
      ...
      { name: "Olive Oil", category: "Fats & Oils", carbs: 0, fat: 100, protein: 0, calories: 884, indicator: "vegi", description: "Primary fat source for keto cooking" },
      { name: "Coconut Oil", category: "Fats & Oils", carbs: 0, fat: 100, protein: 0, calories: 862, indicator: "vegi", description: "High MCT fat ideal for ketogenic diets" },
      { name: "Butter (Unsalted)", category: "Fats & Oils", carbs: 0.1, fat: 81, protein: 0.9, calories: 717, indicator: "vegi", description: "Saturated fat for keto cooking" },
      ...
      { name: "Mozzarella Cheese", category: "Dairy", carbs: 2.2, fat: 22, protein: 22, calories: 280, indicator: "vegi", description: "Mild cheese suitable for children" },
      { name: "Parmesan Cheese", category: "Dairy", carbs: 3.2, fat: 29, protein: 38, calories: 431, indicator: "vegi", description: "Strong flavored, high protein cheese" },
      { name: "Greek Yogurt (Full Fat)", category: "Dairy", carbs: 4.1, fat: 5, protein: 9, calories: 97, indicator: "vegi", description: "Higher protein dairy option" },
      { name: "Almond Milk (Unsweetened)", category: "Dairy", carbs: 0.5, fat: 1.5, protein: 0.5, calories: 17, indicator: "vegi", description: "Low-carb milk alternative" },

      // Non-vegetarian proteins
      { name: "Chicken Breast", category: "Poultry", carbs: 0, fat: 3.6, protein: 31, calories: 165, indicator: "non-vegi", description: "Lean protein source for keto meal planning" },
      { name: "Chicken Thigh (Skinless)", category: "Poultry", carbs: 0, fat: 9, protein: 26, calories: 209, indicator: "non-vegi", description: "Juicier cut with higher fat content" },
      { name: "Salmon (Atlantic)", category: "Fish & Seafood", carbs: 0, fat: 13, protein: 25, calories: 208, indicator: "non-vegi", description: "Rich omega-3 fatty acids, excellent for keto" },
      { name: "Tuna (Canned in Oil)", category: "Fish & Seafood", carbs: 0, fat: 5, protein: 25, calories: 132, indicator: "non-vegi", description: "Convenient protein source" },
      { name: "Sardines", category: "Fish & Seafood", carbs: 0, fat: 11, protein: 25, calories: 208, indicator: "non-vegi", description: "High omega-3 small fish, excellent nutrition" },
      { name: "Mackerel", category: "Fish & Seafood", carbs: 0, fat: 13, protein: 19, calories: 205, indicator: "non-vegi", description: "Fatty fish high in omega-3s" },
      { name: "Beef (Ground, 80% lean)", category: "Beef", carbs: 0, fat: 20, protein: 26, calories: 287, indicator: "non-vegi", description: "Versatile keto protein base" },
      { name: "Beef (Ribeye Steak)", category: "Beef", carbs: 0, fat: 37, protein: 27, calories: 450, indicator: "non-vegi", description: "High-fat cut suitable for higher keto ratios" },
      { name: "Lamb Chops", category: "Lamb", carbs: 0, fat: 24, protein: 25, calories: 315, indicator: "non-vegi", description: "Rich lamb meat with good fat content" },
      { name: "Bacon (Pork)", category: "Pork", carbs: 0.7, fat: 42, protein: 37, calories: 541, indicator: "non-vegi", description: "High-fat cured meat for keto" },
      { name: "Pork Belly", category: "Pork", carbs: 0, fat: 53, protein: 9, calories: 518, indicator: "non-vegi", description: "Very high fat, ideal for 4:1 keto ratio" },
      { name: "Eggs (Whole)", category: "Eggs", carbs: 0.6, fat: 10, protein: 13, calories: 155, indicator: "non-vegi", description: "Complete protein, essential keto food" },
      { name: "Egg Yolks", category: "Eggs", carbs: 3.6, fat: 27, protein: 16, calories: 322, indicator: "non-vegi", description: "Fat and nutrient dense egg component" },
      { name: "Shrimp", category: "Fish & Seafood", carbs: 0.9, fat: 1.4, protein: 24, calories: 106, indicator: "non-vegi", description: "Low fat seafood, high protein" },
      { name: "Cod", category: "Fish & Seafood", carbs: 0, fat: 0.7, protein: 18, calories: 82, indicator: "non-vegi", description: "Lean white fish, mild flavor for children" },
      { name: "Turkey Breast", category: "Poultry", carbs: 0, fat: 1, protein: 29, calories: 135, indicator: "non-vegi", description: "Very lean poultry protein" },
      { name: "Duck (Roasted)", category: "Poultry", carbs: 0, fat: 28, protein: 19, calories: 337, indicator: "non-vegi", description: "High-fat poultry ideal for keto ratios" },

      // Nuts & Seeds
      { name: "Macadamia Nuts", category: "Nuts & Seeds", carbs: 5, fat: 76, protein: 8, calories: 718, indicator: "vegi", description: "Highest fat nut, ideal for keto" },
      { name: "Walnuts", category: "Nuts & Seeds", carbs: 7, fat: 65, protein: 15, calories: 654, indicator: "vegi", description: "Rich in omega-3 fatty acids" },
      { name: "Almonds", category: "Nuts & Seeds", carbs: 10, fat: 50, protein: 21, calories: 579, indicator: "vegi", description: "Popular keto snack nut" },
      { name: "Pecans", category: "Nuts & Seeds", carbs: 4, fat: 72, protein: 9, calories: 691, indicator: "vegi", description: "Very low net carb nut" },
      { name: "Chia Seeds", category: "Nuts & Seeds", carbs: 6, fat: 31, protein: 17, calories: 486, indicator: "vegi", description: "High fiber, omega-3 seeds" },
      { name: "Flaxseeds (Ground)", category: "Nuts & Seeds", carbs: 3, fat: 42, protein: 18, calories: 534, indicator: "vegi", description: "Omega-3 rich seeds for keto baking" },
      { name: "Pumpkin Seeds", category: "Nuts & Seeds", carbs: 3, fat: 49, protein: 30, calories: 559, indicator: "vegi", description: "High protein, magnesium-rich seeds" },
      { name: "Hemp Seeds", category: "Nuts & Seeds", carbs: 3, fat: 49, protein: 32, calories: 553, indicator: "vegi", description: "Complete protein seed with great fat ratio" },

      // Fruits (allowed in moderation on keto)
      { name: "Blueberries", category: "Berries", carbs: 12, fat: 0.3, protein: 0.7, calories: 57, indicator: "fruit", description: "Lower sugar berries for occasional keto use" },
      { name: "Raspberries", category: "Berries", carbs: 5.4, fat: 0.7, protein: 1.2, calories: 52, indicator: "fruit", description: "Low net carb berries for keto" },
      { name: "Strawberries", category: "Berries", carbs: 7.7, fat: 0.3, protein: 0.7, calories: 32, indicator: "fruit", description: "Moderate carb berries in small portions" },
      { name: "Blackberries", category: "Berries", carbs: 5.1, fat: 0.5, protein: 1.4, calories: 43, indicator: "fruit", description: "Low net carb berry option" },
      { name: "Lemon", category: "Citrus", carbs: 9, fat: 0.3, protein: 1.1, calories: 29, indicator: "fruit", description: "Used for flavoring, not eaten whole" },
      { name: "Olives (Black)", category: "Fruits", carbs: 3.8, fat: 11, protein: 0.8, calories: 115, indicator: "fruit", description: "High fat fruit ideal for keto" },
      { name: "Coconut Meat (Unsweetened)", category: "Fruits", carbs: 6, fat: 35, protein: 3.3, calories: 354, indicator: "fruit", description: "High-fat tropical fruit for keto cooking" },
      { name: "Avocado Oil", category: "Fats & Oils", carbs: 0, fat: 100, protein: 0, calories: 884, indicator: "vegi", description: "Neutral-flavored keto-friendly cooking oil" },
      { name: "MCT Oil", category: "Fats & Oils", carbs: 0, fat: 100, protein: 0, calories: 862, indicator: "vegi", description: "Medium-chain triglycerides for rapid ketone production" },
      { name: "Almond Butter (Unsweetened)", category: "Nut Butters", carbs: 7, fat: 50, protein: 21, calories: 614, indicator: "vegi", description: "Keto-friendly nut butter" },
    ];
    ...
    const plans = [
      ...
      },
      {
        ...
        items: [
          ...
          { mealType: "lunch", foodName: "Duck Breast with Cauliflower Mash", portionGrams: 200, unit: "g", calories: 480, carbs: 6, fat: 38, protein: 28 },
          { mealType: "lunch", foodName: "Cream Cheese Dip with Celery", portionGrams: 80, unit: "g", calories: 175, carbs: 2.4, fat: 16, protein: 4 },
  ...
  // ── 5. Seed 15 unique kids ─────────────────────────────────────────────────
  const existingKids = await db.select().from(kidsTable).where(eq(kidsTable.doctorId, doctorId));
  if (existingKids.length < 15) {
    const kidsData = [
    ...
    const existingNames = new Set(existingKids.map((k) => k.name));
    const createdKids = [...existingKids];

    for (const kid of kidsData) {
      if (existingNames.has(kid.name)) continue;
    ...
    // Notes for several kids
    const allKids = await db.select().from(kidsTable).where(eq(kidsTable.doctorId, doctorId));
    const noteContents = [
    ...
    for (let i = 0; i < Math.min(5, allKids.length); i++) {
    ...
    console.log(`Kids seeded: ${allKids.length} total`);
  } else {
    console.log(`Kids already seeded (${existingKids.length} found), skipping.`);
  }
